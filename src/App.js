...
function App() {
  ...
  const [posts, setPosts] = useState([
    ...
    },
    {
      ...
      Ele viveu no apartamento 201 (janelas com grades do meio da fachada) de 1990 até 1996, ano de sua morte. A linda porta de entrada do prédio foi usada na capa de seu disco
      "Stonewall Celebration" de 1994. Outros quatro discos foram criados nesse endereço.
      Atualmente, o apartamento do cantor e compositor está fechado. Tudo em seu interior está do jeito que ele deixou: com todos os seus LPs, livros, móveis e documentos.
    ...
    },
    {
      ...
      A casa vazia já seria motivo para a visitação. O mármore de Carrara do piso foi trazido da Europa e os desenhos geométricos que enfeitam o chão foram criados pelo antigo dono. A espetacular escada em madeira foi esculpida em uma única peça, arrematada pelo casal com o dinheiro da venda de dois apartamentos na Avenida Vieira Souto, em Ipanema.`,
    },
    {
      ...
      comments: 69,
      coordinates: [-22.952075, -43.338358],
      description: `O Edifício que inspirou a série Detetives do Prédio Azul, do canal Gloob, também foi o lar de Ana Maria Teixeira de Carvalho, a eterna musa da bossa-nova e
      "Mulher de Branco" de Ipanema, que faleceu no último dia 3 de agosto, aos 75 anos. Há décadas ela circulava pelas ruas de Ipanema como a mais famosa e polêmica personalidade do bairro.
      Era filha do radialista e jornalista Luis de Carvalho e ex-mulher do compositor Marcos Valle, com quem ajudou a divulgar a bossa-nova pelo mundo. Ana
      Maria, há 16 anos, vendeu sua casa branca na Rua Joana Angélica, n° 207 e comprou um apartamento no térreo do prédio azul, onde vivia com uma acompanhante desde 2007.
